...
namespace Entidades
{
    ...
    public  sealed class Estacionamiento
    {
            ...
            foreach (Vehiculo unVehiculo in unEstacionamiento.vehiculos)
            {
                switch (tipo)
                {
                    case ETipo.Camioneta:
                        ...
                        {
                            sb.AppendLine(((Camioneta)unVehiculo).Mostrar());
                        }
                    ...
                    case ETipo.Moto:
                        ...
                        {
                            sb.AppendLine(((Moto)unVehiculo).Mostrar());
                        }
                    ...
                    case ETipo.Automovil:
                        ...
                        {
                            sb.AppendLine(((Automovil)unVehiculo).Mostrar());
                        }
        ...
        public static Estacionamiento operator +(Estacionamiento unEstacionamiento, Vehiculo unVehiculo)
        {
            ...
            if (unEstacionamiento.vehiculos.Count < unEstacionamiento.espacioDisponible && (!existeEnLista))
            {              
